...
const petImages = {
  ...
  whiteHappy: require('../assets/images/white-happy-cat.png'),
  whiteSad: require('../assets/images/white-sad-cat.png'),
  whiteNeutral: require('../assets/images/white-neutral-cat.png'),
  greyHappy: require('../assets/images/grey-happy-cat.png'),
  greySad: require('../assets/images/grey-sad-cat.png'),
  greyNeutral: require('../assets/images/grey-neutral-cat.png'),
